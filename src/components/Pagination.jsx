          ...
          {links.map((link) => {
            return (
              <button
                ...
                disabled={!link.url}
                className={`${link.active ? "bg-sky-500 hover:bg-sky-600 text-white" : "bg-white hover:bg-sky-200"} first:rounded-lg last:rounded-lg first:rounded-r-none last:rounded-l-none border border-gray-500 border-r-0 last:border size-8 flex justify-center items-center text-sm font-medium disabled:pointer-events-none disabled:opacity-50`}
              >
